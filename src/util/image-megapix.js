...
(function() {
  ...
  function detectVerticalSquash(img, iw, ih) {
    ...
    /**
     * Rendering image element (with resizing) and get its blob data
     */
    function renderImageToBlob(img, options, doSquash, callback) {
        ...
        //
        // canvas.toBlob(function(blob){ if (callback) callback(blob, dataurl); }, "image/jpeg", options.quality || 0.8);
    }
  ...
  MegaPixImage.prototype.render = function(target, options, callback, blobcallback) {
    if (this.imageLoadListeners) {
      var _this = this;
      this.imageLoadListeners.push(function() { _this.render(target, options, callback, blobcallback); });
      return;
    }
    options = options || {};
