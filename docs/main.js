...
/******/ 	var hotCurrentHash = "216b849930e002bf1c07"; // eslint-disable-line no-unused-vars
...
var page_404 = { template: '<div><h2>页面未找到</h2></div>' };
var page_user = { template: '<div>用户 {{ $route.params.id }}<router-view></router-view></div>' };
var page_user_home = { template: '<div>用户主页</div>' };
var page_user_profile = { template: '<div>用户详情</div>' };
var page_user_posts = { template: '<div>用户话题</div>' };
...
var mutations = (_mutations = {
    visit_increment: function visit_increment(state) {
        state.visit_count++;
    }
}, (0, _defineProperty3.default)(_mutations, 'visit_increment', function visit_increment(state, n) {
    state.visit_count += n;
}), (0, _defineProperty3.default)(_mutations, 'error_switch', function error_switch(state, error) {
    state.app_error = error;
}), (0, _defineProperty3.default)(_mutations, 'user_switch', function user_switch(state, user) {
    state.user = user;
}), (0, _defineProperty3.default)(_mutations, 'user_usercode_switch', function user_usercode_switch(state, usercode) {
    state.user_usercode = usercode;
}), (0, _defineProperty3.default)(_mutations, 'user_apptype_switch', function user_apptype_switch(state, apptype) {
...
var getters = {
    ...
    usercode: function usercode(state) {
        return state.user_usercode;
    },
    apptype: function apptype(state) {
...
Component.options.__file = "/zuv/wui/zuv-front/view/src/docs/app.vue"
...
if (true) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2dbf7ea4", Component.options)
  } else {
    hotAPI.reload("data-v-2dbf7ea4", Component.options)
  }
})()}
...
var vrouter = new _vueRouter2.default(RouterConfig);
...
if (true) {
  module.hot.accept()
  if (module.hot.data) {
     __webpack_require__(6).rerender("data-v-2dbf7ea4", module.exports)
  }
}
